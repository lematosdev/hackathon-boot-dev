// Generated from 5e-SRD-Classes.json
// Total items: 12

interface Classes2014Proficiency_choices {
  choose: number;
  desc: string;
  from: object;
  type: string;
...
interface Classes2014Proficiencies {
  index: string;
  name: string;
  url: string;
}

interface Classes2014Saving_throws {
  index: string;
  name: string;
  url: string;
}

interface Classes2014Starting_equipment {
  equipment: object;
  quantity: number;
}

interface Classes2014Starting_equipment_options {
  choose: number;
  desc: string;
  from: object;
  type: string;
...
interface Classes2014Multi_classing {
  prerequisite_options?: object;
  prerequisites?: object[];
  proficiencies: { index: string, name: string, url: string }[];
  proficiency_choices?: object[];
}

interface Classes2014Subclasses {
  index: string;
  name: string;
  url: string;
}

interface Classes2014Spellcasting {
  info: object[];
  level: number;
  spellcasting_ability: object;
}

interface Classes2014 {
  class_levels: string;
  hit_die: number;
  "index": string;
  multi_classing: Classes2014Multi_classing;
  name: string;
  proficiencies: Classes2014Proficiencies[];
  proficiency_choices: Classes2014Proficiency_choices[];
  saving_throws: Classes2014Saving_throws[];
  spellcasting?: Classes2014Spellcasting;
  spells?: string;
  starting_equipment: Classes2014Starting_equipment[] | any[];
  starting_equipment_options: Classes2014Starting_equipment_options[];
  subclasses: Classes2014Subclasses[];
  url: string;
}

// Data export
export const classes2014Data: Classes2014[] = [
  {
    "index": "barbarian",
    "name": "Barbarian",
    "hit_die": 12,
