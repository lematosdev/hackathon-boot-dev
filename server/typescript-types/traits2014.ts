// Generated from 5e-SRD-Traits.json
// Total items: 38

interface Traits2014Races {
  index: string;
  name: string;
  url: string;
}

interface Traits2014Proficiencies {
  index: string;
  name: string;
  url: string;
}

interface Traits2014Proficiency_choices {
  choose: number;
  from: object;
  type: string;
}

interface Traits2014Subraces {
  index: string;
  name: string;
  url: string;
}

interface Traits2014 {
  desc: string[];
  "index": string;
  language_options?: object;
  name: string;
  parent?: object;
  proficiencies: Traits2014Proficiencies[] | any[];
  proficiency_choices?: Traits2014Proficiency_choices;
  races: Traits2014Races[] | any[];
  subraces: Traits2014Subraces[] | any[];
  trait_specific?: object;
  url: string;
}

// Data export
export const traits2014Data: Traits2014[] = [
  {
  "index": "darkvision",
  "races": [
    {
