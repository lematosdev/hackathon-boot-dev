// Generated from 5e-SRD-Weapon-Mastery-Properties.json
// Total items: 8

interface WeaponMasteryProperties2024 {
  description: string;
  "index": string;
  name: string;
  url: string;
...
// Data export
export const weaponmasteryproperties2024Data: WeaponMasteryProperties2024[] = [
  {
  "index": "cleave",
  "name": "Cleave",
...
export type { WeaponMasteryProperties2024 };