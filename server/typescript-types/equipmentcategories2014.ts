// Generated from 5e-SRD-Equipment-Categories.json
// Total items: 39

interface EquipmentCategories2014Equipment {
  index: string;
  name: string;
  url: string;
}

interface EquipmentCategories2014 {
  equipment: EquipmentCategories2014Equipment[];
  "index": string;
  name: string;
  url: string;
}
...
// Data export
export const equipmentcategories2014Data: EquipmentCategories2014[] = [
  {
  "index": "weapon",
  "name": "Weapon",
  "equipment": [
...
export type { EquipmentCategories2014 };