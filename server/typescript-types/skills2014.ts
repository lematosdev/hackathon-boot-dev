// Generated from 5e-SRD-Skills.json
// Total items: 18

interface Skills2014Ability_score {
  index: string;
  name: string;
  url: string;
}

interface Skills2014 {
  ability_score: Skills2014Ability_score;
  desc: string[];
  "index": string;
  name: string;
  url: string;
...
// Data export
export const skills2014Data: Skills2014[] = [
  {
  "index": "acrobatics",
  "name": "Acrobatics",
  "desc": [
