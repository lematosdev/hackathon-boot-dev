...
interface Skills2024Ability_score {
  index: string;
  name: string;
  url: string;
}

interface Skills2024 {
  ability_score: Skills2024Ability_score;
  description: string;
  "index": string;
  name: string;
  url: string;
...
// Data export
export const skills2024Data: Skills2024[] = [
  {
  "index": "acrobatics",
  "name": "Acrobatics",
