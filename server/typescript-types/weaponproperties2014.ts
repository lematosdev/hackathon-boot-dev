// Generated from 5e-SRD-Weapon-Properties.json
// Total items: 11

interface WeaponProperties2014 {
  desc: string[];
  "index": string;
  name: string;
  url: string;
...
// Data export
export const weaponproperties2014Data: WeaponProperties2014[] = [
  {
  "index": "ammunition",
  "name": "Ammunition",
  "desc": [
...
export type { WeaponProperties2014 };