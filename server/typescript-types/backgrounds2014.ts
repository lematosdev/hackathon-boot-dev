// Generated from 5e-SRD-Backgrounds.json
// Total items: 1

interface Backgrounds2014Starting_proficiencies {
  index: string;
  name: string;
  url: string;
}

interface Backgrounds2014Language_options {
  choose: number;
  from: object;
  type: string;
}

interface Backgrounds2014Starting_equipment {
  equipment: object;
  quantity: number;
}

interface Backgrounds2014Starting_equipment_options {
  choose: number;
  from: object;
  type: string;
}

interface Backgrounds2014Feature {
  desc: string[];
  name: string;
}

interface Backgrounds2014Personality_traits {
  choose: number;
  from: object;
  type: string;
}

interface Backgrounds2014Ideals {
  choose: number;
  from: object;
  type: string;
}

interface Backgrounds2014Bonds {
  choose: number;
  from: object;
  type: string;
}

interface Backgrounds2014Flaws {
  choose: number;
  from: object;
  type: string;
}

interface Backgrounds2014 {
  bonds: Backgrounds2014Bonds;
  feature: Backgrounds2014Feature;
  flaws: Backgrounds2014Flaws;
  ideals: Backgrounds2014Ideals;
  "index": string;
  language_options: Backgrounds2014Language_options;
  name: string;
  personality_traits: Backgrounds2014Personality_traits;
  starting_equipment: Backgrounds2014Starting_equipment[];
  starting_equipment_options: Backgrounds2014Starting_equipment_options[];
  starting_proficiencies: Backgrounds2014Starting_proficiencies[];
  url: string;
}

// Data export
export const backgrounds2014Data: Backgrounds2014[] = [
  {
  "index": "acolyte",
  "name": "Acolyte",
