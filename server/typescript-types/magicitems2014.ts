// Generated from 5e-SRD-Magic-Items.json
// Total items: 362

interface MagicItems2014Equipment_category {
  index: string;
  name: string;
  url: string;
}

interface MagicItems2014Rarity {
  name: string;
}

interface MagicItems2014Variants {
  index: string;
  name: string;
  url: string;
}

interface MagicItems2014 {
  desc: string[];
  equipment_category: MagicItems2014Equipment_category;
  image?: string;
  "index": string;
  name: string;
  rarity: MagicItems2014Rarity;
  url: string;
  variant: boolean;
  variants: MagicItems2014Variants[] | any[];
}

// Data export
export const magicitems2014Data: MagicItems2014[] = [
  {
