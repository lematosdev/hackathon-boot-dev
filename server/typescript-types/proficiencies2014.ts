// Generated from 5e-SRD-Proficiencies.json
// Total items: 117

interface Proficiencies2014Classes {
  index: string;
  name: string;
  url: string;
}

interface Proficiencies2014Reference {
  index: string;
  name: string;
  url: string;
}

interface Proficiencies2014 {
  classes: Proficiencies2014Classes[] | any[];
  "index": string;
  name: string;
  races: any[] | object[];
  reference: Proficiencies2014Reference;
  type: string;
  url: string;
}

// Data export
export const proficiencies2014Data: Proficiencies2014[] = [
  {
  "index": "light-armor",
  "type": "Armor",
  "name": "Light Armor",
