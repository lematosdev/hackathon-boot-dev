// Generated from 5e-SRD-Spells.json
// Total items: 319

interface Spells2014Damage {
  damage_at_character_level?: object;
  damage_at_slot_level?: object;
  damage_type: object;
}

interface Spells2014School {
  index: string;
  name: string;
  url: string;
}

interface Spells2014Classes {
  index: string;
  name: string;
  url: string;
}

interface Spells2014Subclasses {
  index: string;
  name: string;
  url: string;
}

interface Spells2014Dc {
  dc_success: string;
  dc_type: object;
}

interface Spells2014Heal_at_slot_level {
  2: string;
  3: string;
  4: string;
  5: string;
...
interface Spells2014Area_of_effect {
  size: number;
  type: string;
}

interface Spells2014 {
  area_of_effect?: Spells2014Area_of_effect;
  attack_type?: string;
  casting_time: string;
  classes: Spells2014Classes[];
  components: string[];
  concentration: boolean;
  damage?: Spells2014Damage;
  dc?: Spells2014Dc;
  desc: string[];
  duration: string;
  heal_at_slot_level?: Spells2014Heal_at_slot_level;
  higher_level?: string[];
  "index": string;
  level: number;
  material?: string;
  ...
  range: string;
  ritual: boolean;
  school: Spells2014School;
  subclasses: Spells2014Subclasses[] | any[];
  url: string;
}

// Data export
export const spells2014Data: Spells2014[] = [
  {
  "index": "acid-arrow",
  "name": "Acid Arrow",
  "desc": [
