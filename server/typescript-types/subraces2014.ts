// Generated from 5e-SRD-Subraces.json
// Total items: 4

interface Subraces2014Race {
  index: string;
  name: string;
  url: string;
}

interface Subraces2014Ability_bonuses {
  ability_score: object;
  bonus: number;
}

interface Subraces2014Racial_traits {
  index: string;
  name: string;
  url: string;
}

interface Subraces2014Starting_proficiencies {
  index: string;
  name: string;
  url: string;
}

interface Subraces2014Language_options {
  choose: number;
  from: object;
  type: string;
}

interface Subraces2014 {
  ability_bonuses: Subraces2014Ability_bonuses[];
  desc: string;
  "index": string;
  language_options?: Subraces2014Language_options;
  languages: any[];
  name: string;
  race: Subraces2014Race;
  racial_traits: Subraces2014Racial_traits[];
  starting_proficiencies: Subraces2014Starting_proficiencies[] | any[];
  url: string;
}

// Data export
export const subraces2014Data: Subraces2014[] = [
  {
  "index": "hill-dwarf",
  "name": "Hill Dwarf",
  "race": {
